...
| Generic OpenAI-compatible | `OPENAI_COMPATIBLE_API_KEY` (optional) |
...
config["llm_provider"] = "openai"        # e.g. openai, google, anthropic, deepseek, mimo, groq, bedrock, ollama; openai_compatible covers custom endpoints
